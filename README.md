...
For detailed information about the application architecture, design patterns, and project structure, see the [Architecture Documentation](Docs/Architecture.md).
